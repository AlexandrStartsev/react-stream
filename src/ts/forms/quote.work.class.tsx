...
import { ChoiceInfo, required, AsyncContextBase } from "../api/dfe-stream";
...
const StateComponent = Pipe({get: (loc: ICoreCommWorkLocation) => stringChoiceMaker(loc.state, states), val: simplyRequired})(
    (props: {model: ICoreCommWorkLocation, context: AsyncContextBase, data?: ChoiceInfo<string>, processNoSpecificLocationChange: (loc: ICoreCommWorkLocation, context: AsyncContextBase, newState: string, newNoSpecificLocation: string) => void, error?: string}) => <td>
        <Dropdown 
            emptyOption={false}
            data={props.data} 
...
const NoSpecificComponent = Pipe()((props: {model: ICoreCommWorkLocation, context: AsyncContextBase, processNoSpecificLocationChange: (loc: ICoreCommWorkLocation, context: AsyncContextBase, newState: string, newNoSpecificLocation: string) => void}) =>
...
const LocationRowComponent = Pipe()((props: {model: ICoreCommWorkLocation, processNoSpecificLocationChange: (loc: ICoreCommWorkLocation, context: AsyncContextBase, newState: string, newNoSpecificLocation: string) => void, showAvailable: (effectiveDt: string, state: string) => void}) => {
    let loc = props.model;
    return (
        <Fragment>
            <tr>
...
const LocationContainerComponent = Pipe({
    ...
    val: function(locs) {
        ...
        processNoSpecificLocationChange: (loc: ICoreCommWorkLocation, context: AsyncContextBase, newState: string, newNoSpecificLocation: string) => void, 
...
const QuoteWorkClassComponent = Pipe({get: (root: ICoreCommVs) => root.policy.workSet})(
    class extends React.Component<{model: ICoreCommVs, data?: ICoreCommWork}> {
        ...
        processNoSpecificLocationChange(loc: ICoreCommWorkLocation, context: AsyncContextBase, newState: string, newNoSpecificLocation: string) {
